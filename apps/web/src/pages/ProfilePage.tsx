  ...
  return (
    <main className="flex-1 px-4 pt-8 pb-28">
      <div className="max-w-2xl mx-auto flex flex-col gap-6">
        ...
        <Card>
          <h2 className="text-base font-semibold mb-2">Perfil veterinario</h2>

          {/* Solo lectura: la verificacion la otorga el equipo desde el panel. */}
          {user?.isVet ? (
            <div className="flex items-center gap-2">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              La verificación como profesional la otorga el equipo. Escribinos si sos veterinario/a.
            </p>
          )}
        </Card>

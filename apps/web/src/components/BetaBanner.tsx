...
export default function BetaBanner() {
  ...
  return (
    <div className="bg-amber-50 dark:bg-amber-900/30 border-b border-amber-200 dark:border-amber-800 px-4 py-2 flex items-center justify-between gap-4 text-sm text-amber-800 dark:text-amber-200">
      ...
      <button
        ...
        className="shrink-0 text-amber-600 dark:text-amber-300 hover:text-amber-800 text-lg leading-none"
      >
        ×
      </button>
    </div>
